      ...
      <section>
        ...
        <form className="max-w-3xl mx-auto pt-8" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-20 gap-10 md:mb-20 mb-8">
            <div>
              <label className="block text-gray-200 text-sm md:text-xl font-semibold mb-2">
                VOTRE PRENOM
              </label>
              <input
                name="prename"
                ...
                className="w-full py-3 text-white text-sm md:text-xl bg-base-300 border-b border-white/50 focus:border-red-500 outline-none"
          ...
          <div className="mb-8">
            ...
            <textarea
              ...
              rows={4}
              className="w-full py-3 text-white text-sm md:text-xl bg-base-300 border-b border-white/50 focus:border-red-500 outline-none resize-none"
          ...
          <button
            type="submit"
            className="w-full bg-red-600 hover:bg-red-900 text-white py-3 font-semibold"
          >
