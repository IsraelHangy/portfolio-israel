          ...
          >
            ...
            <div className="flex flex-wrap gap-2 my-3">
              {project.technologies.map((tech, idx) => (
                <span key={idx} className="badge bg-red-800 md:bg-red-700 badge-sm">
                  {tech}
                </span>
              ))}
            </div>
            <div className="flex">
              <a
                ...
                className="btn btn-lg bg-red-800 md:bg-red-700 hover:bg-red-900 active:scale-95 transition-transform duration-150 w-2/3 text-white"
              >
